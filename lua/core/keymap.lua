...
-- map("n", "<A-\\>", "bdaw")                 -- 回退删除一个单词
-- map("i", "<A-\\>", "<C-w>")                -- 回退删除一个单词
...
map("n", "<A-t>", ":vnew term://bash<CR>") -- 开启一个terminal
map("t", "<Esc>", "<C-\\><C-n>")           -- exit terminal

map("n", "<A-1>", ":tabnew<CR>")           -- 新建一个tab
map("n", "<A-2>", ":tabnext<CR>")          -- 下一个tab
map("n", "<A-3>", ":tabprevious<CR>")      -- 前一个tab

map("n", "<A-c>", "~")                     -- reverse case
map("i", "<A-c>", "<C-o>~")                -- reverse case

map("n", "<A-S-u>", "gUaWel")              -- upper case
map("i", "<A-S-u>", "<C-o>gUaWel")         -- upper case
map("n", "<A-S-l>", "guaWel")              -- lower case
map("i", "<A-S-l>", "<C-o>guaWel")         -- lower case
